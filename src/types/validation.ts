...
export function isUser(obj: any): obj is User {
  return (
    ...
    (obj.avatar === undefined || typeof obj.avatar === 'string' || obj.avatar === null) &&
...
export function isProject(obj: any): obj is Project {
  return (
    ...
    (obj.parentProjectId === undefined || typeof obj.parentProjectId === 'string' || obj.parentProjectId === null) &&
    (obj.createdAt instanceof Date || typeof obj.createdAt === 'string') &&
    (obj.updatedAt instanceof Date || typeof obj.updatedAt === 'string')
  );
}
...
export function isTask(obj: any): obj is Task {
  return (
    ...
    (obj.dueDate === undefined || obj.dueDate === null || obj.dueDate instanceof Date || typeof obj.dueDate === 'string') &&
    (obj.dueTime === undefined || obj.dueTime === null || typeof obj.dueTime === 'string') &&
    (obj.duration === undefined || obj.duration === null || typeof obj.duration === 'number') &&
    (obj.recurringPattern === undefined || obj.recurringPattern === null || typeof obj.recurringPattern === 'string') &&
    (obj.parentTaskId === undefined || obj.parentTaskId === null || typeof obj.parentTaskId === 'string') &&
    typeof obj.order === 'number' &&
    typeof obj.completed === 'boolean' &&
    (obj.completedAt === undefined || obj.completedAt === null || obj.completedAt instanceof Date || typeof obj.completedAt === 'string') &&
    (obj.projectId === undefined || obj.projectId === null || typeof obj.projectId === 'string') &&
    (obj.sectionId === undefined || obj.sectionId === null || typeof obj.sectionId === 'string') &&
    (obj.assigneeId === undefined || obj.assigneeId === null || typeof obj.assigneeId === 'string') &&
...
export function isSidebarState(obj: any): obj is SidebarState {
  return (
    ...
    (obj.collapsedSections === undefined || typeof obj.collapsedSections === 'object') &&
...
function isTaskModalState(obj: any): boolean {
  return (
    ...
    (obj.mode === undefined || typeof obj.mode === 'string' || obj.mode === null)
  );
}
...
function isSettingsModalState(obj: any): boolean {
  return (
    ...
    typeof obj === 'object' &&
    typeof obj.isOpen === 'boolean' &&
    (obj.activeTab === undefined || typeof obj.activeTab === 'string' || obj.activeTab === null)
  );
}
 ...
 */
export function isKeyboardShortcutsState(obj: any): obj is KeyboardShortcutsState {
  return (
    obj &&
    typeof obj === 'object' &&
...
export class DataValidator {
  ...
  static validateTaskStatus(status: any): status is TaskStatus {
    return ['active', 'completed', 'archived', 'pending', 'in-progress'].includes(status);
  }
  ...
  static validateLabelColor(color: any): color is LabelColor {
    const validColors = [
      ...
      'blue-500', 'indigo-500', 'purple-500', 'pink-500', 'gray-500'
    ];
    return validColors.includes(color);
  }
  ...
  static validateAuthProvider(provider: any): provider is AuthProvider {
    return ['email', 'google', 'github', 'apple', 'microsoft'].includes(provider);
  }
   ...
   */
  static validateProjectVisibility(visibility: any): visibility is ProjectVisibility {
...
export class DataTransformer {
  ...
  static stringToTaskStatus(value: string): TaskStatus {
    ...
    if (['active', 'completed', 'archived', 'pending', 'in-progress'].includes(status)) {
...
export class SchemaValidator {
  ...
  static validateUserSchema(user: any): { valid: boolean; errors: string[] } {
    ...
    if (!user.email || typeof user.email !== 'string' || !DataValidator.validateEmail(user.email)) {
    ...
    if (user.avatar !== undefined && typeof user.avatar !== 'string' && user.avatar !== null) {
      errors.push('User avatar must be a string or null');
    }

    if (user.createdAt !== undefined && !(user.createdAt instanceof Date) && typeof user.createdAt !== 'string') {
      errors.push('User createdAt must be a Date or string');
    }

    if (user.updatedAt !== undefined && !(user.updatedAt instanceof Date) && typeof user.updatedAt !== 'string') {
   ...
   */
  static validateProjectSchema(project: any): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
    ...
    if (!project.name || typeof project.name !== 'string' || project.name.length > 100) {
    ...
    if (!project.color || typeof project.color !== 'string' || !DataValidator.validateProjectColor(project.color)) {
      errors.push('Project color must be a valid project color');
    }

    if (!project.viewType || typeof project.viewType !== 'string' || !DataValidator.validateViewType(project.viewType)) {
    ...
    if (project.parentProjectId !== undefined && typeof project.parentProjectId !== 'string' && project.parentProjectId !== null) {
      errors.push('Project parentProjectId must be a string or null');
    }

    if (project.createdAt !== undefined && !(project.createdAt instanceof Date) && typeof project.createdAt !== 'string') {
      errors.push('Project createdAt must be a Date or string');
    }

    if (project.updatedAt !== undefined && !(project.updatedAt instanceof Date) && typeof project.updatedAt !== 'string') {
  ...
  static validateTaskSchema(task: any): { valid: boolean; errors: string[] } {
    ...
    if (!task.title || typeof task.title !== 'string' || task.title.length > 200) {
    ...
    if (!task.status || typeof task.status !== 'string' || !DataValidator.validateTaskStatus(task.status)) {
      errors.push('Task status must be a valid task status');
    }

    if (!task.priority || typeof task.priority !== 'string' || !DataValidator.validatePriority(task.priority)) {
      errors.push('Task priority must be a valid priority level');
    }

    if (task.dueDate !== undefined && task.dueDate !== null && !(task.dueDate instanceof Date) && typeof task.dueDate !== 'string') {
    ...
    if (task.duration !== undefined && task.duration !== null && typeof task.duration !== 'number') {
      errors.push('Task duration must be a number or null');
    }

    if (task.recurringPattern !== undefined && task.recurringPattern !== null && typeof task.recurringPattern !== 'string') {
      errors.push('Task recurringPattern must be a string or null');
    }

    if (task.parentTaskId !== undefined && task.parentTaskId !== null && typeof task.parentTaskId !== 'string') {
    ...
    if (task.completedAt !== undefined && task.completedAt !== null && !(task.completedAt instanceof Date) && typeof task.completedAt !== 'string') {
    ...
    if (task.sectionId !== undefined && task.sectionId !== null && typeof task.sectionId !== 'string') {
      errors.push('Task sectionId must be a string or null');
    }

    if (task.assigneeId !== undefined && task.assigneeId !== null && typeof task.assigneeId !== 'string') {
    ...
    if (task.attachmentIds !== undefined && !Array.isArray(task.attachmentIds)) {
    ...
    if (task.customFields !== undefined && (typeof task.customFields !== 'object' || task.customFields === null)) {
      errors.push('Task customFields must be an object');
    }

    if (task.createdAt !== undefined && !(task.createdAt instanceof Date) && typeof task.createdAt !== 'string') {
      errors.push('Task createdAt must be a Date or string');
    }

    if (task.updatedAt !== undefined && !(task.updatedAt instanceof Date) && typeof task.updatedAt !== 'string') {
