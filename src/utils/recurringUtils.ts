 ...
 */
export const validateRecurringTaskConfig = (config: RecurringTaskConfig): { valid: boolean; errors: string[] } => {
  const errors: string[] = [];
 ...
 */
export const calculateRecurringTaskCompletionRate = (task: Task, instances: RecurringTaskInstance[]): number => {
 ...
 */
export const getNextOccurrenceDate = (task: Task, config: RecurringTaskConfig): Date | null => {
 ...
 */
export const getRecurringTaskStatistics = (task: Task, instances: RecurringTaskInstance[]): {
