...
describe("Collaboration Services", () => {
  ...
  describe("CollaborationService", () => {
    ...
    it("should validate team data correctly", () => {
      ...
      expect(() => {
        collaborationService["validateTeam"]({
          ...mockTeam,
          name: "a".repeat(101),
        });
    ...
    it("should validate member data correctly", () => {
      ...
      // Test invalid role
      expect(() => {
        collaborationService["validateMember"]({
          ...mockMember,
          role: "invalid" as any,
        });
  ...
  describe("CollaborationActivityService", () => {
    ...
    it("should validate activity data correctly", () => {
      ...
      // Test invalid user ID
      expect(() => {
        collaborationActivityService["validateActivity"]({
          ...mockActivity,
          userId: "",
        });
      }).toThrow("User ID is required");
    ...
    it("should filter activities by type", () => {
      ...
      const taskActivities =
        collaborationActivityService.filterActivitiesByType(activities, "task");
    ...
    it("should sort activities by timestamp", () => {
      ...
      const sorted =
        collaborationActivityService.sortActivitiesByTimestamp(activities);
  ...
  describe("Service Integration", () => {
    it("should have all required methods", () => {
      ...
      expect(typeof collaborationActivityService.createActivity).toBe(
        "function",
      );
      expect(typeof collaborationActivityService.getActivitiesByTeam).toBe(
        "function",
      );
      expect(typeof collaborationActivityService.getRecentActivities).toBe(
        "function",
      );
      expect(typeof collaborationActivityService.getActivitiesByUser).toBe(
        "function",
      );
      expect(typeof collaborationActivityService.deleteActivity).toBe(
        "function",
      );
    });
  });
