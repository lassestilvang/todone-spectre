...
describe("Animation System Accessibility Tests", () => {
  ...
  describe("Animation System Integration Tests", () => {
    it("should integrate animation controls with accessibility features", () => {
      ...
      expect(
        container.querySelector('[aria-label="Animation controls"]'),
      ).toBeInTheDocument();
      expect(
        container.querySelector('[aria-label="Task animation in progress"]'),
      ).toBeInTheDocument();
    });
