...
test.describe('User Onboarding Flow', () => {
  test('Complete user onboarding: Registration → Login → Task creation → Project setup', async ({ page }) => {
    ...
    await test.step('Create first task', async () => {
      ...
      await expect(page.locator(`text="${TEST_TASK.description}"`)).toBeVisible();
    });
