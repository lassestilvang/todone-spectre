...
describe('StatusBadge Component', () => {
  const testStatuses: TaskStatus[] = ['completed', 'in-progress', 'archived', 'todo'];
  ...
  describe('Rendering', () => {
    ...
    it('should render with archived status', () => {
      ...
      expect(screen.getByText('Archived')).toHaveClass('bg-purple-100 text-purple-800');
    });
  ...
  describe('Styling', () => {
    ...
    it('should apply custom className when provided', () => {
      ...
      const { container } = render(<StatusBadge status="completed" className={customClass} />);
