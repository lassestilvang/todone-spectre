...
const mockDb = {
  ...
  projects: {
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'project-1', name: 'Test Project' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  sections: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'section-1', name: 'Test Section' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  tasks: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'task-1', content: 'Test Task' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  labels: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'label-1', name: 'Test Label' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  filters: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'filter-1', name: 'Test Filter' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  comments: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'comment-1', text: 'Test Comment' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
  attachments: {
    filter: jest.fn().mockReturnThis(),
    ...
    toArray: jest.fn().mockResolvedValue([{ id: 'attachment-1', name: 'Test Attachment' }]),
    clear: jest.fn().mockResolvedValue(undefined)
  },
...
describe('DatabaseUtils', () => {
  ...
  describe('getIndexInfo', () => {
    ...
    it('should throw error for unknown table', async () => {
      await expect(dbUtils.getIndexInfo('unknown-table'))
        .rejects.toThrow('Table unknown-table not found in schema');
    });
  });
  ...
  describe('validateDataBeforeInsert', () => {
    ...
    it('should throw error for invalid user data', async () => {
      ...
      await expect(dbUtils.validateDataBeforeInsert('users', invalidUserData))
        .rejects.toThrow('User email is required');
    });

    it('should throw error for null data', async () => {
      await expect(dbUtils.validateDataBeforeInsert('users', null))
