...
interface TemplateContextType {
  ...
  applyTemplate: (templateId: string, variables?: Record<string, string>) => Promise<string>;
...
export const TemplateProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const applyTemplate = async (templateId: string, variables?: Record<string, string>): Promise<string> => {
  ...
  const createTemplateFromTask = async (taskContent: string): Promise<Template> => {
