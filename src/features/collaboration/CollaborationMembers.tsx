...
export const CollaborationMembers: React.FC<CollaborationMembersProps> = ({
  ...
  const { members, loading, error, updateMemberRole, updateTeamSettings } =
    useCollaboration();
  const [searchTerm, setSearchTerm] = useState("");
  const [roleFilter, setRoleFilter] = useState<
    "all" | CollaborationMember["role"]
  >("all");
  const [statusFilter, setStatusFilter] = useState<
    "all" | CollaborationMember["status"]
  >("all");
  ...
  const [newMemberRole, setNewMemberRole] =
    useState<CollaborationMember["role"]>("member");
  ...
  const handleRoleChange = async (
    ...
    try {
      ...
      setPendingRoleChanges((prev) =>
        prev.filter((change) => change.memberId !== memberId),
      );
    } catch (err) {
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1">
                <Select
                  value={roleFilter}
                  onValueChange={(value) =>
                    setRoleFilter(value as "all" | CollaborationMember["role"])
                  }
                >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setStatusFilter(
                      value as "all" | CollaborationMember["status"],
                    )
                  }
                >
                  <SelectTrigger className="w-[120px] text-sm">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            <Badge
                              variant={getStatusBadge(member.status).variant}
                              className="text-xs"
                            >
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={newMemberRole}
                onValueChange={(value) =>
                  setNewMemberRole(value as CollaborationMember["role"])
                }
              >
                <SelectTrigger>
              ...
              <p className="text-xs text-muted-foreground">
                ...
                {newMemberRole === "member" &&
                  "Standard team member with full collaboration access"}
                {newMemberRole === "guest" &&
                  "Limited access to view team content"}
              </p>
            </div>
          </div>
          <DialogFooter>
