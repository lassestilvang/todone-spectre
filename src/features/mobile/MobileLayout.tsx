...
export const MobileLayout: React.FC<MobileLayoutProps> = ({ children, title = 'Todone', showNavigation = true }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <StatusBar barStyle={mobileConfig.darkMode ? 'light-content' : 'dark-content'} />
