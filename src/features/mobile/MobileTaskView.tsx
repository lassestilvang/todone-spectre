...
import { View, Text, StyleSheet, TouchableOpacity, Animated, PanResponder, GestureResponderEvent } from 'react-native';
...
export const MobileTaskView: React.FC<MobileTaskViewProps> = ({ task, onComplete, onDelete, onSwipeLeft, onSwipeRight }) => {
  ...
  return (
    ...
    >
      ...
      <View style={styles.taskContent}>
        <Text style={[styles.taskDescription, mobileConfig.darkMode ? styles.darkText : styles.lightText]}>
      ...
      <View style={styles.taskFooter}>
        <View style={styles.taskPriority}>
          <Text style={[styles.priorityText, getPriorityStyle(task.priority, mobileConfig.darkMode)]}>
