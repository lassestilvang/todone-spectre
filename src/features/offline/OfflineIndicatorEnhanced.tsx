...
> = ({
  ...
  const getConnectionQualityClass = () => {
    switch (connectionQuality) {
      ...
      case "fair":
        return "connection-quality-fair";
      case "poor":
        return "connection-quality-poor";
      default:
  ...
  return (
    <div
      className={`offline-indicator-enhanced ${getStatusClass()} ${positionClasses[position]}`}
    >
        ...
        {showAdvancedStats && (
          <div className="offline-indicator-advanced">
            <div className="connection-quality">
              <span
                className={`connection-quality-dot ${getConnectionQualityClass()}`}
              />
                ...
                {connectionHistory
                  ...
                  .map((entry, index) => (
                    <div key={index} className="connection-history-item">
                      ...
                      <span
                        className={`connection-history-status ${entry.status}`}
                      >
                        {entry.status}
                      </span>
