      ...
      <div className="ml-4 flex items-center space-x-2">
        ...
        >
          <span className="flex items-center">
            ...
            Commands
            <kbd className="ml-2 px-1 py-0.5 text-xs border border-gray-300 rounded bg-gray-100">
              Ctrl
            </kbd>
            <kbd className="px-1 py-0.5 text-xs border border-gray-300 rounded bg-gray-100">
              K
            </kbd>
          </span>
        </button>
