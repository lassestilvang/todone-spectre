...
describe('Search Integration Tests', () => {
  ...
  describe('SearchModal Component', () => {
    it('should not render when closed', () => {
      ...
      expect(screen.queryByPlaceholderText('Search for tasks, projects, labels...')).not.toBeInTheDocument();
    });

    it('should render when open', () => {
      render(<SearchModal isOpen={true} onClose={() => {}} />);
      expect(screen.getByPlaceholderText('Search for tasks, projects, labels...')).toBeInTheDocument();
    });
  });
