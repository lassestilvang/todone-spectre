...
import { Template, TemplateCategory, CreateTemplateDto, CreateTemplateCategoryDto } from '../../../types/template';

/**
 * Generate mock template data for testing
 */
export const generateMockTemplate = (overrides: Partial<Template> = {}): Template => {
  return {
 ...
 */
export const generateMockTemplateCategory = (overrides: Partial<TemplateCategory> = {}): TemplateCategory => {
  return {
 ...
 */
export const generateMockCreateTemplateCategoryDto = (overrides: Partial<CreateTemplateCategoryDto> = {}): CreateTemplateCategoryDto => {
  return {
...
export const generateMockTemplates = (count: number = 5): Template[] => {
  return Array.from({ length: count }, (_, i) => generateMockTemplate({
 ...
 */
export const generateMockTemplateCategories = (count: number = 3): TemplateCategory[] => {
  return Array.from({ length: count }, (_, i) => generateMockTemplateCategory({
...
export const createMockTemplateService = () => {
  ...
  return {
    ...
    getTemplate: async (id: string) => mockTemplates.find(t => t.id === id) || null,
    ...
    getTemplateCategory: async (id: string) => mockCategories.find(c => c.id === id) || null,
    ...
    updateTemplateCategory: async (id: string, updates: Partial<TemplateCategory>) => {
 ...
 */
export const expectTemplateToMatch = (actual: Template, expected: Partial<Template>) => {
