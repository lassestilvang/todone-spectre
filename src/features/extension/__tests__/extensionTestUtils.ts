import { ExtensionState, ExtensionConfig, ExtensionMessage, QuickAction } from '../../../types/extensionTypes';
 ...
 */
export const createMockExtensionState = (overrides: Partial<ExtensionState> = {}): ExtensionState => ({
  status: 'idle',
 ...
 */
export const createMockQuickAction = (overrides: Partial<QuickAction> = {}): QuickAction => ({
  id: 'test-action',
  label: 'Test Action',
  icon: 'test',
  ...overrides
