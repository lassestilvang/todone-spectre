...
export const SubTaskItem: React.FC<SubTaskItemProps> = ({
  ...
  const handleToggleCompletion = useCallback(async (e: React.MouseEvent) => {
    e.stopPropagation();
    try {
  ...
  return (
    <div
      className={`p-3 border rounded-lg shadow-sm hover:shadow-md transition-shadow ${
        subTask.completed ? 'bg-green-50 border-green-200' : 'bg-white border-gray-100'
      }`}
    >
          ...
          {subTask.dueDate && (
            <div className="flex items-center text-xs text-gray-500 mt-1">
              <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 002 2z" />
              </svg>
