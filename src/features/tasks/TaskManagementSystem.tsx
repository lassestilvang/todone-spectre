...
import { PlusIcon, ArrowRightIcon, CalendarIcon } from '@heroicons/react/outline';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          ...
          <div className="text-2xl font-bold text-gray-900 mt-1">{regularTasks.length}</div>
        </div>
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          <div className="text-purple-600 font-medium text-sm">Recurring Tasks</div>
          <div className="text-2xl font-bold text-gray-900 mt-1">{recurringTasks.length}</div>
        </div>
        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
          <div className="text-green-600 font-medium text-sm">Total Tasks</div>
          <div className="text-2xl font-bold text-gray-900 mt-1">{regularTasks.length + recurringTasks.length}</div>
        </div>
      </div>
