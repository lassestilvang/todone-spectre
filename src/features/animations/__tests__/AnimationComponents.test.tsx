...
import { createAnimationTestContext } from './animationServiceMocks';

describe('Animation Components', () => {
  const mockContext = createAnimationTestContext();
  ...
  describe('AnimationProvider', () => {
    it('should provide animation context', () => {
      const TestComponent = () => {
        ...
        return <div data-testid="context">{context.isAnimating ? 'true' : 'false'}</div>;
      };
