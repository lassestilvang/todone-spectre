...
export const AnimationPerformanceOptimizer: React.FC<AnimationPerformanceOptimizerProps> = ({
  children,
  maxConcurrentAnimations = 3,
  throttleDuration = 100,
  performanceMode = 'balanced'
}) => {
  const { isAnimating, animationSpeed, setAnimationSpeed } = useAnimationContext();
      ...
      {isAnimating && (
        <div style={{
          ...
          <div style={{
            ...
            animation: performanceStats.isThrottled ? 'pulse 1s infinite' : 'none'
          }} />
