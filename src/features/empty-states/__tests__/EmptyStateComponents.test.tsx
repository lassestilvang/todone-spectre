...
import { generateMockEmptyStateConfig, generateMockOnboardingSteps } from './emptyStateTestUtils';
...
describe('EmptyState Components', () => {
  ...
  describe('EmptyStateTemplate', () => {
    it('should render tasks template', () => {
      ...
      expect(screen.getByText('Create your first task to get started with your productivity journey')).toBeInTheDocument();
    });
