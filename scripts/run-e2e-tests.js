...
function runTests() {
  ...
  try {
    ...
    console.log(
      "   • Cross-feature Interactions: All major features integrated",
    );
    console.log(
      "   • Authentication Flows: Login, registration, session management",
    );
    console.log(
      "   • Error Recovery: Form validation, network issues, data conflicts",
    );
    console.log();

    console.log("🎯 Running all E2E tests...");
    console.log(
      "This may take a few minutes as tests run across multiple browsers.",
    );
    ...
    console.log(
      "4. Run tests individually with `npx playwright test src/__tests__/e2e/<test-file>`",
    );
  }
}
...
function showHelp() {
  ...
  console.log();
  console.log(
    "Browsers tested: Chrome, Firefox, Safari, Mobile Chrome, Mobile Safari, Tablet",
  );
  console.log(
